...
from erpnext.accounts.doctype.process_statement_of_accounts.process_statement_of_accounts import ProcessStatementOfAccounts

class ProcessStatementOfAccountsCustom(ProcessStatementOfAccounts):
	def validate(self):
		if not self.subject:
...
def get_html(doc, filters, entry, col, res, ageing):
	...
	template_path = (
		"doodle_custom/doodle_custom/utils/process_statement_of_accounts_custom.html"
		if doc.report == "General Ledger"
		else "doodle_custom/doodle_custom/utils/process_statement_of_accounts_accounts_receivable_custom.html"
	)
